...
urlpatterns = [
    ...
    path('like/<int:foreignUser_pk>/<int:pk>/<int:post_pk>',
    ...
    path('view/<int:foreignUser_pk>/profile/<int:pk>/postDetail/<int:post_pk>/errors/notAllow',
         views.errors_notAllow, name='notAllow'),
]
